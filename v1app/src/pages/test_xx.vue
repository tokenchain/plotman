  ...
  <section id="indexbox" class="indexcolor">
    <div class="backee home">
      ...
      <loaddisc
        ...
        loading-text="One Moment network..."
        disc-type="black"/>

    </div>
    <v-app class="box-wrap vapp center">
      <section class="section_tron_enter">
        <v-btn color="red line_btn" dark @click.native="goto_main">CONNECT</v-btn>
  ...
  methods: {
    goto_main() {
      if (this.tronlinkinstalled) {
        if (this.isNile()) {
          this.straightInto("masonic_main")
        } else {
